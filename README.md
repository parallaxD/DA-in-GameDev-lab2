...
В результате работы, я научился записывать на python механику / логику изменения игровой переменной, аередавать результаты в таблицу и использовать эти данные в Unity.
